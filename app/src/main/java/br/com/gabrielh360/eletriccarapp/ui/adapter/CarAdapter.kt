package br.com.gabrielh360.eletriccarapp.ui.adapter
...
class CarAdapter(private val carros: List<Carro>, private val isFavoriteScreen : Boolean = false) :
    ...
    // Pega o conteudo da view e troca pela informação de intem de uma lista.
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            view.apply {
                preco = findViewById(R.id.car_preco_value)
                bateria = findViewById(R.id.car_bateria_value)
                potencia = findViewById(R.id.car_potencia_value)
                recarga = findViewById(R.id.car_recarga_value)
